...
def initialize_models():
    # Initialize RandomForest with some manually set hyperparameters
    return  RandomForestClassifier(n_estimators=1000 , verbose=5, n_jobs=-1)
...
def main(data_path, output_file):
    ...
    for fold_idx, (train_idx, test_idx) in enumerate(rsfk.split(X_data, y_data)):
        ...
        fold_metrics = print_metrics(y_test, rf_pred, rf_proba, 'rf', classes)
...
if __name__ == "__main__":
    main("cancer/libsvm/data_VGG.txt", "resultsRFVGG.txt")
