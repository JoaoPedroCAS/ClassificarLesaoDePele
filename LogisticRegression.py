...
def initialize_models():
    # Initialize LinearDiscriminantAnalysis with some manually set hyperparameters
...
def main(data_path, output_file):
    ...
    for fold_idx, (train_idx, test_idx) in enumerate(rsfk.split(X_data, y_data)):
        ...
        fold_metrics = print_metrics(y_test, lr_pred, lr_proba, 'LR', classes)
...
if __name__ == "__main__":
    main("cancer/libsvm/data_Xception.txt", "resultsLRXception.txt")
